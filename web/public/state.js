...
export const state = {
  ...
  slashCommands: [
    ...
    {
      name: "/realtime",
      desc: "Realtime voice (CLI only in web build)",
      cliOnly: true,
    },
    {
      name: "/fast",
      desc: "Plan-usage toggle (CLI only in web build)",
      cliOnly: true,
    },
    {
      name: "/title",
      desc: "Terminal title (CLI only in web build)",
      cliOnly: true,
    },
    {
      name: "/statusline",
      desc: "Statusline control (CLI only in web build)",
      cliOnly: true,
    },
