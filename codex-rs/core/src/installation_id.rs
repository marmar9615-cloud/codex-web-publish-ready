...
pub(crate) async fn resolve_installation_id(codex_home: &AbsolutePathBuf) -> Result<String> {
    ...
    tokio::task::spawn_blocking(move || {
        ...
        // Serialize concurrent readers/writers across processes. Stable in
        // 1.89 and above; the stdlib dispatches to flock on Unix and
        // LockFileEx on Windows, so this works cross-platform without any
